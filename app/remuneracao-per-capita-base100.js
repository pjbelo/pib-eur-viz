...
export function showChartRpcBase100(data_repc) {
    ...
    function lineEnter(event, data) {
        ...
        d3.selectAll("path.line").style("stroke-width", 0.5)
        ...
        <p>Crescimento da remuneração dos empregados per capita (PPS)</p>
